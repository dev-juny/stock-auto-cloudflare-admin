...
export function LogViewer() {
    ...
    return (_jsxs(Card, { children: [_jsxs("div", { className: "flex items-center justify-between mb-3", children: [_jsx("h2", { className: "text-sm font-semibold text-text-primary", children: "\uC2DC\uC2A4\uD15C \uB85C\uADF8" }), logs.length > 0 && (_jsxs("span", { className: "text-[11px] text-text-muted", children: [logs.length, "\uAC74"] }))] }), display.length === 0 ? (_jsx("p", { className: "text-xs text-text-muted py-4 text-center", children: "\uB85C\uADF8\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4" })) : (_jsx("div", { className: "space-y-1", children: display.map((l) => {
                    ...
                    const Icon = cfg.icon;
                    return (_jsxs("div", { className: "flex items-start gap-2.5 py-2 border-b border-surface-border last:border-0", children: [_jsx("div", { className: `mt-0.5 ${cfg.color}`, children: _jsx(Icon, { size: 13 }) }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsxs("div", { className: "flex items-center gap-2 mb-0.5", children: [_jsx("span", { className: `text-[10px] font-medium px-1.5 py-0.5 rounded ${cfg.bg} ${cfg.color}`, children: level }), _jsx("span", { className: "text-[10px] text-text-muted font-mono", children: l.source }), _jsx("span", { className: "text-[10px] text-text-muted/60 font-mono tabular-nums ml-auto", children: formatTime(l.created_at) })] }), _jsx("div", { className: "text-xs text-text-primary leading-snug", children: l.message })] })] }, l.id));
