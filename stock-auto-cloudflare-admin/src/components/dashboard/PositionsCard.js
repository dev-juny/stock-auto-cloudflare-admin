...
export function PositionsCard() {
    ...
    return (_jsxs(Card, { children: [_jsxs("div", { className: "flex items-center justify-between mb-3", children: [_jsx("h2", { className: "text-sm font-semibold text-text-primary", children: "\uBCF4\uC720 \uD3EC\uC9C0\uC158" }), _jsxs("span", { className: "text-[11px] text-text-muted", children: [positions.length, "\uAC1C"] })] }), _jsx("div", { className: "space-y-1", children: positions.map((p) => {
                    ...
                    return (_jsxs("div", { className: "flex items-center gap-3 py-2.5 px-3 rounded-xl bg-surface border border-surface-border", children: [_jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("div", { className: "text-sm font-medium text-text-primary truncate", children: formatStockDisplay(p.name, p.ticker) }), _jsxs("div", { className: "text-[11px] text-text-muted font-mono tabular-nums", children: [p.quantity ?? 0, "\uC8FC @ ", formatKRW(p.entry_price ?? 0)] })] }), _jsxs("div", { className: "text-right", children: [_jsx("div", { className: `text-sm font-semibold font-mono tabular-nums ${isPositive ? 'text-success' : 'text-danger'}`, children: formatPct(pnl) }), _jsxs("div", { className: `text-[11px] font-mono tabular-nums ${isPositive ? 'text-success' : 'text-danger'}`, children: [amt >= 0 ? '+' : '', formatKRW(amt)] })] })] }, p.ticker));
                }) })] }));
}
