...
export default function SettingsPage() {
    ...
    async function saveRisk() {
        if (!riskSettings)
            return;
        const clean = Object.fromEntries(Object.entries(riskSettings).map(([k, v]) => [k, v === '' ? 0 : v]));
        setRiskSaving(true);
        try {
